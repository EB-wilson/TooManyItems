...
class RecipeItemStack(
  ...
  //属性设置的工具方法
  fun setEff(efficiency: Float): RecipeItemStack {
    this.efficiency = efficiency
    return this
  }

  @JvmOverloads
  fun setOptional(optionalCons: Boolean = true): RecipeItemStack {
    this.optionalCons = optionalCons
    return this
  }

  @JvmOverloads
  fun setAttribute(isAttr: Boolean = true): RecipeItemStack {
    this.isAttribute = isAttr
    return this
  }

  @JvmOverloads
  fun setBooster(boost: Boolean = true): RecipeItemStack {
    isBooster = boost
    return this
  }

  @JvmOverloads
  fun setMaxAttr(isMax: Boolean = true): RecipeItemStack {
    this.maxAttribute = isMax
    return this
  }
